# Hatch-Pet Worker Delegation

Read this reference before assigning generation, blind-review, or final visual
QA workers.

## Contents

- [Lightweight Visual Workers](#lightweight-visual-workers)
- [Subagent Delegation](#subagent-delegation)
- [Model Choice](#model-choice)
- [Base Worker Prompt](#base-worker-prompt)
- [Cardinal-Strip Worker Prompt](#cardinal-strip-worker-prompt)
- [Row Worker Prompt](#row-worker-prompt)
- [Blind Direction QA Worker Prompt](#blind-direction-qa-worker-prompt)
- [Final Visual QA Worker Prompt](#final-visual-qa-worker-prompt)
...
Choose worker models as follows:
...
### Blind Direction QA Worker Prompt

Use this prompt in a fresh worker that has not seen the labeled direction sheet. Spawn it without prior conversation context when the worker system supports context isolation (for example, `fork_turns="none"`):
