# Hatch-Pet Look Directions And QA

Read this reference after standard-row QA and before generating cardinal anchors
or either look-direction row.

## Contents

- [Required V2 Look-Direction Stage](#required-v2-look-direction-stage)
- [Direction Acceptance Policy](#direction-acceptance-policy)
- [Blind Review Severity Resolution](#blind-review-severity-resolution)
